...
function FeaturedCard({ project }: { project: Project }) {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="gradient-border glass rounded-2xl p-6 glass-hover transition-all duration-300 flex flex-col gap-4 group"
    >
      ...
      <div className="flex items-center gap-2 pt-2 border-t border-white/10">
        ...
        <svg className="w-4 h-4 ml-auto text-slate-600 group-hover:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
