    ...
    <section className="relative min-h-screen flex items-center pt-20 pb-28 px-6 overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="font-mono text-xs md:text-sm text-violet-400 tracking-widest">{t.badge}</span>
        </div>
        ...
        <div className="flex flex-wrap gap-3 md:gap-4 justify-center">
          <a href="#projects" className="btn-primary text-sm md:text-base">{t.cta1}</a>
        ...
        <div className="flex gap-8 md:gap-12 pt-2 md:pt-4">
          <div className="text-center">
            ...
            <div className="text-[10px] md:text-xs text-slate-500 mt-1">Projets</div>
          </div>
          <div className="w-px bg-white/10" />
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold gradient-text">25+</div>
            <div className="text-[10px] md:text-xs text-slate-500 mt-1">Technologies</div>
          </div>
          <div className="w-px bg-white/10" />
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold gradient-text">4+</div>
            <div className="text-[10px] md:text-xs text-slate-500 mt-1">{t.statYears}</div>
          </div>
        </div>
      </div>
